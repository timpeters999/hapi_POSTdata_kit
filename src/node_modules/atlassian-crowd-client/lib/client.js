...
var _get = function get(_x31, _x32, _x33) { var _again = true; _function: while (_again) { var object = _x31, property = _x32, receiver = _x33; desc = parent = getter = undefined; _again = false; if (object === null) object = Function.prototype; var desc = Object.getOwnPropertyDescriptor(object, property); if (desc === undefined) { var parent = Object.getPrototypeOf(object); if (parent === null) { return undefined; } else { _x31 = parent; _x32 = property; _x33 = receiver; _again = true; continue _function; } } else if ('value' in desc) { return desc.value; } else { var getter = desc.get; if (getter === undefined) { return undefined; } return getter.call(receiver); } } };
    ...
    this.group = {
      ...
      users: {
        ...
        list: function list(groupname) {
          ...
          return _this.request('GET', '/group/user/' + (nested ? 'nested' : 'direct') + '?groupname=' + groupname + '&start-index=' + startIndex + '&max-results=' + maxResults).then(function (res) {
